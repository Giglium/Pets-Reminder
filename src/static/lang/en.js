    ...
    en: {
      message: {
        ...
        form: {
          ...
          errors:{
            title: "Error",
            io: "Error durign operation. Please try again.",
        ...
        settings:{
          ...
          reload:{
            title: "Attention",
            text: "Are you shure to modify theme? The app we'll be reloaded.",
          },

        },
        home:{
          title: "Your beautiful pets:",
          noAnimal: "You can insert your first animal pressing + on the bottom right corner",
        },
        termsandconditions:{
          termsAndConditions: "Terms and Conditions",
          title1: "ACCEPTANCE OF TERMS",
          paragraph1: "The services that Pets Reminder provides to User is subject to the following Terms and Conditions of Use (\"TOU\"). Please read the TOU carefully before accessing, using or obtaining any materials, information, products or services. By accessing the Pets Reminder mobile or tablet applications, you agree to be bound by the TOU and our Privacy Policy. If you do not accept all the provisions of the TOU and/or Privacy Policy , you may not use Our Services. Without prejudice to the general contract law of EU Member States (such as the rules on the validity, formation or effect of a contract in relation to a child), the accessing of the Services, provided by Pets Remindes, of a child under the age of 16, can be undertaken by Pets Reminder only if and to the extent that consent is given or authorized by the holder of parental responsibility over the child. The parents or guardians of children under the age of 16 are responsible for giving their consent for any such Personal Information their children may provide online, through the Pets Reminder mobile applications.",
          title2: "DESCRIPTION OF SERVICES",
          paragraph2:"Through Our Application, we provide User with Services. The Services, including any updates, enhancements, new features, and/or the addition of any new Web properties, are subject to the TOU. Information provided by the Users, through the Services, may contain image from to third party websites that are not owned or controlled by Pets Reminder. Pets Reminder has no control over third-party websites and/or services; Pets Reminder cannot censor or edit the content of such websites and thus assumes no responsibility and cannot be held liable for the content, privacy policies and/or practices of such websites.",
          title3: "EQUIPMENT",
          paragraph3: "User shall be responsible for obtaining and maintaining all telephone, computer hardware, software and other equipment needed for access to and use of Our Services and all charges related to it.",
        },
        credits: {
          credits: "Credits",
